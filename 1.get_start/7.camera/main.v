...
fn main() {
    ...
    for !window.should_close() {
        ...
        radius := 10.0
        cam_x := math.sin(glfw.get_time()) * radius
        cam_z := math.cos(glfw.get_time()) * radius

        view = glm.look_at(glm.vec3(cam_x, 0.0, cam_z), glm.vec3(0.0, 0.0, 0.0), glm.vec3(0.0, 1.0, 0.0))
